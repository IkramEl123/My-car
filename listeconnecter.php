...
<a href="formulaire.php" class="btn btn-primary" style="float:right;margin-bottom:20px;">
...
$query="select email,password from connecter";
...
<tr>
    ...
    <td>
        <a href="modifconnecter.php?id=<?php echo $ligne["email"] ?>" type="button"class="btn btn-success">
    ...
    <td> 
        <!-- Bouton au lieu de lien pour Supprimer -->
              <div class="modal-footer">
                ...
                <a href="deleteconnecter.php?cd=<?php echo $ligne["email"]; ?>" type="button" class="btn btn-primary" >Save changes</a>
              </div>
            </div>
          </div>
        </div>
