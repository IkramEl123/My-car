...
<a href="client.php" class="btn btn-primary" style="float:right;margin-bottom:20px;">
...
$query = "SELECT cin, nom, prenom, dateNaissance, adresse, telephone, email, password FROM client";
...
<tr>
    ...
    <td>
        <a href="modifierclient.php?id=<?php echo $ligne["cin"] ?>" type="button"class="btn btn-success">
    ...
    <td> 
        <!-- Bouton au lieu de lien pour Supprimer -->
              <div class="modal-footer">
                ...
                <a href="deleteclient.php?cd=<?php echo $ligne["cin"]; ?>" type="button" class="btn btn-primary" >Save changes</a>
              </div>
            </div>
          </div>
        </div>
