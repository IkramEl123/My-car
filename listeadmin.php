  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="listeadmin.php">Admin</a>
                </li>
...
<a href="ajouteradmin.php" class="btn btn-primary" style="float:right;margin-bottom:20px;">
...
$query="select numcin,mdp from administrateur";
...
?>
<tr>
    <td> <?php echo $ligne["numcin"]; ?></td>
    <td> <?php echo $ligne["mdp"]; ?></td>
    <td>
        <a href="updatedate.php?id=<?php echo $ligne["numcin"] ?>" type="button"class="btn btn-success">
    ...
    <td> 
        <!-- Bouton au lieu de lien pour Supprimer -->
              <div class="modal-footer">
                ...
                <a href="deletedate.php?cd=<?php echo $ligne["numcin"]; ?>" type="button" class="btn btn-primary" >Save changes</a>
              </div>
            </div>
          </div>
        </div>
