...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->connect_error) {
        ...
        if ($stmt === false) {
            $message = "Échec de la préparation de la requête: " . $conn->error;
        } else {
            ...
            if ($result->num_rows > 0) {
                $message = "La voiture est déjà louée pendant cette période.";
            } else {
                ...
                // Vérification de la préparation de la requête d'insertion
                if ($stmt_insert === false) {
                    $message = "Échec de la préparation de la requête d'insertion: " . $conn->error;
                } else {
                    ...
                    if ($stmt_insert->execute()) {
                        $message1 = "La période de location a été ajoutée avec succès.";
                    } else {
                        $message1 = "Erreur lors de l'ajout de la période de location: " . $conn->error;
                    }
            ...
            // Fermeture du statement de sélection
            $stmt->close();
        }
